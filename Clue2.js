...
function submitQuest() {
  ...
  const expectedAnswer = 40.5; // Use a decimal number for the expected answer

  // Use a small epsilon value for comparing floating-point numbers to account for rounding errors
